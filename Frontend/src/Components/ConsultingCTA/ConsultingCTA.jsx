...
import "./ConsultingCTA.css";
import { FaArrowRight } from "react-icons/fa";

const AllServicesCTA = () => {
  return (
    <section className="consulting-cta">
      <div className="consulting-cta-overlay" />

      <div className="consulting-cta-container">
        {/* LEFT */}
        <div className="consulting-cta-left">
          <span className="consulting-tag">[ GET IN TOUCH ]</span>
          ...
          <button className="consulting-primary-btn">
        ...
        {/* RIGHT */}
        <div className="consulting-cta-form">
          <h3>
          ...
          <form>
            ...
            <div className="consulting-form-full">
              <label>Type Message</label>
              <textarea />
            </div>

            <button className="consulting-submit-btn">
