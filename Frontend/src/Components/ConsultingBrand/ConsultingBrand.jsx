...
export default function AllServicesBrand() {
  return (
    <section className="consultinng-wrapper">
      <div className="consultinng-title">
        Join Over <span>1000+</span> Companies with Tekmino Here
      </div>

      <div className="consultinng-slider">
        <div className="consultinng-track">
          {[...brands, ...brands].map((logo, i) => (
            <div className="consultinng-card" key={i}>
