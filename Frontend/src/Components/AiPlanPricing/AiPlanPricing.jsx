  ...
  return (
    <section className="ai-plan-section">
      ...
      <div className="ai-plan-header">
        <span className="ai-plan-tag">[ BEST PRICING ]</span>
        <h2>
          Pricing Plans to Find the <br /> Right IT Support
        </h2>

        {/* Toggle */}
        <div className="ai-plan-toggle">
          <span className={!yearly ? "active" : ""}>Monthly</span>

          <div
            className={`ai-plan-switch ${yearly ? "yearly" : ""}`}
      ...
      <div className="ai-plan-grid">
        {plans.map((plan, i) => (
          ...
          >
            <h3>{plan.name}</h3>
            <p className="ai-plan-sub">{plan.desc}</p>
