...
import "./ConsultingPlanPricing.css";
...
const AllServicesPlanPriceing = () => {
  ...
  return (
    <section className="consultingg-section">
      {/* Header */}
      <div className="consultingg-header">
        <span className="consultingg-tag">[ BEST PRICING ]</span>
        <h2>
          Pricing Plans to Find the <br /> Right IT Support
        </h2>

        {/* Toggle */}
        <div className="consultingg-toggle">
          <span className={!yearly ? "active" : ""}>Monthly</span>

          <div
            className={`consultingg-switch ${yearly ? "yearly" : ""}`}
      ...
      {/* Pricing Cards */}
      <div className="consultingg-grid">
        {plans.map((plan, i) => (
          <div
            key={i}
            className={`consultingg-card ${plan.featured ? "featured" : ""}`}
          >
            <h3>{plan.name}</h3>
            <p className="consultingg-sub">{plan.desc}</p>
