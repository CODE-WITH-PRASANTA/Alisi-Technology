...
import EnterpriseViewPrice from "./EnterPriseViewPrice";
...
const EnterpriseSolution = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await API_URL.put(`/enterprise-prices/${editingId}`, form);
      } else {
        await API_URL.post("/enterprise-prices", form);
      }
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      >
        <h2 className="text-xl font-semibold">
          {editingId ? "Edit Enterprise Plan" : "Add Enterprise Plan"}
        </h2>
