...
import CloudViewPrice from "./CloudViewPrice";
...
const CloudComputing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await API_URL.put(`/cloud-prices/${editingId}`, form);
        alert("Cloud Plan Updated ✅");
      } else {
        await API_URL.post("/cloud-prices", form);
        alert("Cloud Plan Created ✅");
      }
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      >
        <h2 className="text-xl font-semibold">
          {editingId ? "Edit Cloud Plan" : "Add Cloud Plan"}
        </h2>
