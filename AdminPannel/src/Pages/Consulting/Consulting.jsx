...
import ConsultingViewPrice from "./ConsoltingViewPrice";
...
const Consulting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await API_URL.put(`/consulting-prices/${editingId}`, form);
        alert("Consulting Plan Updated ✅");
      } else {
        await API_URL.post("/consulting-prices", form);
        alert("Consulting Plan Created ✅");
      }
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      >
        <h2 className="text-xl font-semibold">
          {editingId ? "Edit Consulting Plan" : "Add Consulting Plan"}
        </h2>
      ...
      <div className="bg-[#0f141b] border border-slate-800 rounded-2xl p-6">
        ...
        <div className="border border-slate-700 p-4 rounded-xl bg-[#0b0f14]">
          ...
          <p className="text-slate-400">CONSULTING</p>
