...
const ConsultingViewPrice = ({ refreshKey, onEdit }) => {
  ...
  const deletePrice = async (id) => {
    if (!window.confirm("Delete this Consulting plan?")) return;

    try {
      await API_URL.delete(`/consulting-prices/${id}`);
      fetchPrices();
    } catch (err) {
...
export default ConsultingViewPrice;