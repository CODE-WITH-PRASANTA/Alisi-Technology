...
import CognitiveViewPrice from "./CognitiveViewPrice";
...
const CognitiveOperation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await API_URL.put(`/cognitive-prices/${editingId}`, form);
        alert("Cognitive Plan Updated ✅");
      } else {
        await API_URL.post("/cognitive-prices", form);
        alert("Cognitive Plan Created ✅");
      }
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      >
        <h2 className="text-xl font-semibold">
          {editingId ? "Edit Cognitive Plan" : "Add Cognitive Plan"}
        </h2>
...
export default CognitiveOperation;